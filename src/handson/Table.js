...
"css!./Table"], factory);
    ...
    Column.prototype.publish("minRange", 0, "number", "Minimum value of a handsontable", function () { return this._owner ? this._owner.columns() : []; }, { tags: ["Basic"], optional: true });
    Column.prototype.publish("maxRange", 20, "number", "Maximum value of a handsontable", function () { return this._owner ? this._owner.columns() : []; }, { tags: ["Basic"], optional: true });
